...
export default function MobileNavigation({ cartCount, isAdminUser }: { cartCount: number; isAdminUser: boolean }) {
  ...
  return (
    <div className="md:hidden">
      ...
      <nav className="mobile-safe-bottom fixed inset-x-0 bottom-0 z-40 grid grid-cols-5 border-t border-stone-200 bg-white/95 px-2 pt-2 shadow-[0_-4px_16px_rgb(0_0_0/0.08)] backdrop-blur" aria-label="Quick mobile navigation">
