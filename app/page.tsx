...
export default async function Home() {
  ...
  return (
    <CustomerShell>
      ...
      <section className="mt-6 grid gap-5 rounded-2xl border border-stone-200 bg-white p-5 shadow-sm sm:mt-8 sm:grid-cols-2 sm:rounded-3xl sm:p-8">
        <div><p className="text-sm font-semibold uppercase tracking-[0.2em] text-amber-600">About {restaurantSettings.restaurantName}</p><h2 className="mt-2 text-2xl font-semibold text-stone-900">Good food, made for good company.</h2><p className="mt-3 text-sm leading-6 text-stone-600">Drop in for a relaxed meal, order your favorites online, or let us bring the taste of Pizza Vizza to you.</p></div>
